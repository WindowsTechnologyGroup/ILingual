...
===================================================================================-->
	...
	<xsl:template match="WTENTITY">
		...
		<xsl:value-of select="concat($tab0, 'Class=C', /Data/@project, '; C', /Data/@project, '.cls', $cr)"/>
		<xsl:value-of select="concat($tab0, 'Class=C', /Data/@project, 's; C', /Data/@project, 's.cls', $cr)"/>
		<xsl:if test="/Data/@userbusn">
		...
		<xsl:value-of select="concat($tab0, 'Module=', $appprefix, 'CommonUserMod; ..\_common\', $appprefix, 'CommonUserMod.bas', $cr)"/>
		...
		<xsl:value-of select="concat($tab0, 'Module=', $appprefix, 'XMLMod; ..\_common\', $appprefix, 'XMLMod.bas', $cr)"/>
		<xsl:value-of select="concat($tab0, 'Startup=&quot;(None)&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'HelpFile=&quot;&quot;', $cr)"/>

		<xsl:value-of select="concat($tab0, 'Title=&quot;', $prefix, 'User&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'ExeName32=&quot;', $prefix, 'User.dll&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'Path32=&quot;..\..\LIB', $cr)"/>
		<xsl:value-of select="concat($tab0, 'Command32=&quot;&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'Name=&quot;', $prefix, 'User&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'HelpContextID=&quot;0&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'Description=&quot;', $appprefix, ' ', /Data/@project, ' User Library&quot;', $cr)"/>

		<xsl:value-of select="concat($tab0, 'CompatibleMode=&quot;1&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'CompatibleEXE32=&quot;..\..\LIB\', $prefix, 'User.dll&quot;', $cr)"/>
		...
		<xsl:value-of select="concat($tab0, 'VersionComments=&quot;', $appprefix, ' ', /Data/@project, ' User Library&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'VersionCompanyName=&quot;WinTech, Inc.&quot;', $cr)"/>
		<xsl:value-of select="concat($tab0, 'VersionFileDescription=&quot;', $appprefix, ' ', /Data/@project, ' User Library&quot;', $cr)"/>
		...
		<xsl:value-of select="concat($tab0, 'ThreadingModel=1', $cr)"/>
