...
<!--	<xsl:variable name="tab" select="''"/>-->
	<xsl:variable name="MenuStr" select="'s=s+'"/>

	<!--==================================================================-->
	<xsl:template match="WTMENU">
	<!--==================================================================-->
		...
		<xsl:if test="not(@custom)">
			...
			<xsl:value-of select="concat($ind0, 's = &quot;&lt;MENU')"/>
			<!-- Get All Attributes -->
			<xsl:for-each select="@*">
			...
			<xsl:value-of select="concat($ind0, $MenuStr, '&quot;&lt;/MENU&gt;&quot;', $cr)"/>
			<xsl:if test="$persist='true'">
	...
	<!--==================================================================-->
		...
		<xsl:value-of select="concat($cr, 'BOBTEST', $cr)"/>
		...
		<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;ITEM')"/>
		<!-- Get All Attributes -->
		<xsl:for-each select="@*">
			<xsl:variable name="valuetype"><xsl:call-template name="QualifiedType"><xsl:with-param name="value" select="."/></xsl:call-template></xsl:variable>
			<xsl:variable name="valuetext"><xsl:call-template name="QualifiedValue"><xsl:with-param name="value" select="."/></xsl:call-template></xsl:variable>
		...
		<xsl:if test="not(WTITEM) and not(WTLINK) and not(WTIMAGE) and not(WTCODEGROUP)">
			<xsl:value-of select="concat('/&gt;&quot;', $cr)"/>
		</xsl:if>

		<xsl:if test="WTITEM or WTLINK or WTIMAGE or WTCODEGROUP">
			<xsl:value-of select="concat('&gt;&quot;', $cr)"/>
			...
			<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;/ITEM&gt;&quot;', $cr)"/>
		</xsl:if>
	...
	<!--=================================================================-->
	<xsl:template match="WTITEM/WTIMAGE">
	<!--==================================================================-->
		<xsl:param name="indent"/>
		<xsl:variable name="ind0" select="$indent"/>
		<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;IMAGE')"/>
		<!-- Get All Attributes -->
		<xsl:for-each select="@*">
				<xsl:value-of select="concat(' ', name(), '=&quot;&quot;', ., '&quot;&quot;')"/>
		</xsl:for-each>
	...
	<!--=================================================================-->
	<xsl:template match="WTITEM/WTDIVIDER">
	<!--==================================================================-->
		<xsl:param name="indent"/>
		<xsl:variable name="ind0" select="$indent"/>
		<xsl:variable name="hasconditions" select="(count(WTCONDITION) > 0)"/>
		...
		<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;DIVIDER/&gt;&quot;', $cr)"/>
	...
	<!--==================================================================-->
		...
		<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;LINK')"/>
		<!-- Get All Attributes -->
		<xsl:for-each select="@*">
				<xsl:value-of select="concat(' ', name(), '=&quot;&quot;', ., '&quot;&quot;')"/>
		</xsl:for-each>
		...
		<xsl:if test="WTPARAM">
			...
			<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;/LINK&gt;&quot;', $cr)"/>
		</xsl:if>
	...
	<!--==================================================================-->
		...
		<xsl:value-of select="concat($MenuStr, $ind0, '&quot;&lt;PARAM')"/>
	...
	<!--=================================================================-->
	<xsl:template match="WTMENU/WTCODEGROUP">
	<!--==================================================================-->
		<xsl:param name="indent"/>
		<xsl:variable name="ind0" select="$indent"/>
		<xsl:variable name="hasconditions" select="(count(WTCONDITION) > 0)"/>
